...
# Increase the alpha to make colors bolder
...
ax1.set_xticks(ticks=[i * 0.5 for i in range(-5, 6)])  # Adjust the range as needed

ax2 = ax1.twinx()
ax2.set_ylabel('Hurricane Category Strength ', fontsize=10, labelpad=7, fontweight='bold')

# Adding horizontal lines with reduced opacity
...
# Calculate the number of hurricanes for each ENSO value range
